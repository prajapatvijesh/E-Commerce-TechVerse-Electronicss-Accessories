...
export const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-dark-900 transition-colors">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 md:relative bg-white dark:bg-dark-800 border-r border-gray-200 dark:border-dark-700 transition-all duration-300 transform ${isSidebarOpen ? 'translate-x-0 w-64' : '-translate-x-full md:translate-x-0 md:w-20'}`}
      >
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-dark-700">
          ...
          <button
            ...
            className="p-2 rounded-md hover:bg-gray-100 dark:hover:bg-dark-700 text-gray-500 hidden md:block"
          >
            <Menu size={20} />
          </button>
          <button
            onClick={() => setIsSidebarOpen(false)}
            className="p-2 rounded-md hover:bg-gray-100 dark:hover:bg-dark-700 text-gray-500 md:hidden"
          >
            <Menu size={20} />
          </button>
        </div>
