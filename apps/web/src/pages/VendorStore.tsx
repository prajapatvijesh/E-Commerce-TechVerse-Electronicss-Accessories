  ...
  return (
    <div className="space-y-12">
      <Helmet>
        ...
        <meta
          name="description"
          content={`Shop products from ${vendor.name}, our top-rated vendor.`}
        />
      </Helmet>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-6 -mt-16 relative z-10">
            ...
            <div className="flex space-x-3 pb-2">
              <Button
                ...
                onClick={() => {
                  if (!user) {
                    toast.error('Please login first to contact the vendor');
                  } else {
                    dispatch(
                      openChat({
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          },
          {
            ...
            title: 'Quick Support',
            desc: 'Usually responds in 1 hour',
          },
        ].map((item, i) => (
          <div
            key={i}
            className="bg-white dark:bg-dark-800 p-6 rounded-2xl border border-gray-100 dark:border-dark-700 text-center flex flex-col items-center"
          >
            ...
            <h4 className="font-bold text-sm dark:text-white mb-1">
              {item.title}
            </h4>
          ...
          {vendorProducts?.map((product: any, i: number) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1">
                <span className="text-xs font-medium text-primary-600 mb-1 uppercase tracking-wider">
