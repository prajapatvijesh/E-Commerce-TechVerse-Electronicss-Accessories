...
export const Home: React.FC = () => {
  ...
  const heroBanner = bannersData?.find(
    (b: any) => b.position === 'hero' && b.isActive
  );
  ...
  return (
    <div className="space-y-24">
      <Helmet>
        ...
        <meta
          name="description"
          content="Shop the latest smartphones, laptops, and gadgets from top vendors on TechVerse."
        />
      </Helmet>
      ...
      <section className="relative rounded-[2.5rem] overflow-hidden bg-black text-white min-h-[650px] flex items-center shadow-2xl border border-white/10 group">
        ...
        <div
          className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-blue-600/30 rounded-full mix-blend-screen filter blur-[120px] animate-pulse"
        ...
        <div className="absolute inset-0 z-0">
          <img
            src={
              heroBanner?.image ||
              cmsData?.heroBanners?.[0]?.image ||
              'https://images.unsplash.com/photo-1618424181497-157f25b6ce53?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80'
            }
            alt="Hero Background"
        ...
        <div className="relative z-10 px-8 md:px-16 max-w-5xl mx-auto md:mx-0">
          ...
          >
            {heroBanner?.title || cmsData?.heroBanners?.[0]?.title || 'Welcome'}
          </motion.h1>
          ...
          >
            {cmsData?.heroBanners?.[0]?.subtitle ||
          ...
          >
            <Link
              to={
                heroBanner?.link || cmsData?.heroBanners?.[0]?.link || '/shop'
              }
            >
              <Button
                size="lg"
                variant="primary"
                className="w-full sm:w-auto font-bold text-lg px-10 py-5 rounded-2xl shadow-[0_0_40px_rgba(var(--color-primary-500),0.4)] hover:shadow-[0_0_60px_rgba(var(--color-primary-500),0.6)] transition-all"
              >
                Shop Collection
              </Button>
            </Link>
            <Link to="/compare">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto font-semibold text-lg px-10 py-5 rounded-2xl bg-white/5 backdrop-blur-md border-white/10 hover:bg-white/10 text-white transition-all hover:border-white/30"
              >
                Compare Specs
              </Button>
            </Link>
      ...
      <section>
        <div className="flex justify-between items-end mb-8 relative z-10">
          ...
          <Link
            to="/shop"
            className="text-primary-600 hover:text-primary-500 hover:underline font-medium flex items-center space-x-1"
          >
            <span>View All</span>
            <span>&rarr;</span>
          </Link>
              ...
              >
                ...
                >
                  <div className="h-full bg-white/60 backdrop-blur-xl dark:bg-dark-800/60 rounded-[2rem] p-8 border border-white/40 dark:border-dark-600/30 text-center hover:shadow-[0_20px_50px_rgba(16,185,129,0.15)] dark:hover:shadow-[0_20px_50px_rgba(16,185,129,0.05)] hover:-translate-y-2 transition-all duration-500 relative overflow-hidden flex flex-col justify-center items-center">
                    ...
                    <h3 className="font-bold text-xl text-gray-900 dark:text-white group-hover:text-primary-600 transition-colors relative z-10">
                      {category.name}
                    </h3>
                  </div>
                </Link>
              ...
              >
                <div className="bg-white/70 backdrop-blur-md dark:bg-dark-800/70 border border-white/40 dark:border-dark-700/50 rounded-2xl overflow-hidden shadow-sm hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] transition-all duration-300 group">
                  <Link
                    ...
                    className="relative h-64 overflow-hidden bg-gray-50 dark:bg-dark-900/50 p-6 flex items-center justify-center"
                  >
                  ...
                  <div className="mt-auto flex flex-col flex-1 p-5">
                    ...
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-50 dark:border-dark-700/50">
                      ...
                      <Button
                        ...
                        className="rounded-full w-10 h-10 p-0 flex items-center justify-center hover:scale-110 transition-transform shadow-md shadow-primary-500/20"
                      >
      ...
      <section className="relative rounded-[2.5rem] overflow-hidden bg-gradient-to-br from-primary-900 to-black text-white p-12 md:p-16 flex flex-col md:flex-row items-center justify-between shadow-2xl border border-primary-500/20">
        ...
        <div className="relative z-10 max-w-2xl">
          <Badge
            variant="info"
            className="mb-4 bg-primary-500 text-white border-transparent"
          >
            Limited Time Offer
          </Badge>
          <h2 className="text-4xl md:text-5xl font-black mb-4">
            Get 20% Off Your First Tech Purchase!
          </h2>
          <p className="text-gray-300 text-lg mb-8">
            Join thousands of tech enthusiasts and experience premium quality
            with TechVerse. Use code{' '}
          ...
          <Link to="/shop">
            <Button
              size="lg"
              variant="primary"
              className="font-bold rounded-2xl px-8 shadow-lg shadow-primary-500/30"
            >
              Shop Now
            </Button>
          </Link>
        ...
        <div className="flex justify-between items-end mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-2">
              Discover premium products from our best sellers.
            </p>
          </div>
          <Link
            to="/vendors"
          ...
          {[
            {
              ...
              sales: '10k+',
              image:
                'https://api.dicebear.com/7.x/shapes/svg?seed=TechNova&backgroundColor=0ea5e9',
            },
            {
              name: 'ElectroMart',
              rating: 4.8,
              sales: '8k+',
              image:
                'https://api.dicebear.com/7.x/shapes/svg?seed=ElectroMart&backgroundColor=f97316',
            },
            {
              name: 'GadgetHub Pro',
              rating: 4.7,
              sales: '5k+',
              image:
                'https://api.dicebear.com/7.x/shapes/svg?seed=GadgetHub&backgroundColor=10b981',
            },
            {
              ...
              sales: '2k+',
              image:
                'https://api.dicebear.com/7.x/shapes/svg?seed=Audio&backgroundColor=8b5cf6',
            },
          ].map((vendor, i) => (
            <motion.div
              key={i}
            ...
            >
              ...
              <div className="flex items-center justify-center text-sm text-gray-500 bg-gray-50 dark:bg-dark-900 py-1.5 px-3 rounded-full mx-auto w-fit">
                <Award size={14} className="mr-1 text-primary-500" />{' '}
                {vendor.sales} Sales
              </div>
            </motion.div>
          ))}
      ...
      <section className="bg-primary-50 dark:bg-primary-900/10 rounded-3xl p-10 md:p-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              text: 'The delivery was incredibly fast and the MacBook Pro arrived in perfect condition. TechVerse is my go-to for all things tech now!',
              author: 'Sarah Jenkins',
              role: 'Software Engineer',
            },
            {
              text: "I couldn't find this specific camera lens anywhere else. The vendor communication was top-notch and the price was unbeatable.",
              author: 'Michael Chen',
              role: 'Photographer',
            },
            {
              text: 'Outstanding customer service! I had an issue with my smartwatch and the return process was seamless and completely hassle-free.',
              author: 'Emma Watson',
              role: 'Fitness Coach',
            },
          ].map((testimonial, i) => (
            <div
              key={i}
              className="bg-white dark:bg-dark-800 p-8 rounded-3xl shadow-sm relative"
            >
              <Quote
                size={40}
                className="text-primary-100 dark:text-primary-900/30 absolute top-6 left-6"
              />
      ...
      <section className="bg-white dark:bg-dark-800 rounded-3xl p-10 md:p-16 border border-gray-100 dark:border-dark-700/50 flex flex-col md:flex-row items-center justify-between text-center md:text-left shadow-sm">
        <div className="mb-6 md:mb-0 max-w-xl">
          <h2 className="text-3xl font-extrabold dark:text-white tracking-tight mb-2">
        ...
        >
          <div className="relative flex-1 sm:w-80">
            ...
            <input
              ...
              required
              className="w-full pl-12 pr-4 py-4 rounded-2xl bg-gray-50 dark:bg-dark-900 border border-gray-200 dark:border-dark-700 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:text-white"
            />
          </div>
          <Button
            type="submit"
