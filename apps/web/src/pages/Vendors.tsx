...
export const mockVendors = [
  { id: '1', name: 'TechNova Global', rating: 4.9, sales: '10k+', image: 'https://api.dicebear.com/7.x/shapes/svg?seed=TechNova&backgroundColor=0ea5e9', location: 'Rajasthan, Jodhpur', description: 'Welcome to TechNova Global! We specialize in premium electronics, smart home devices, and high-end accessories. Our mission is to provide the best quality products with exceptional customer service. All our products come with a minimum 1-year warranty.' },
  { id: '2', name: 'ElectroMart', rating: 4.8, sales: '8k+', image: 'https://api.dicebear.com/7.x/shapes/svg?seed=ElectroMart&backgroundColor=f97316', location: 'Mumbai, Maharashtra', description: 'ElectroMart is your one-stop shop for everything electrical. From components to consumer appliances, we deliver quality at unbeatable prices.' },
  { id: '3', name: 'GadgetHub Pro', rating: 4.7, sales: '5k+', image: 'https://api.dicebear.com/7.x/shapes/svg?seed=GadgetHub&backgroundColor=10b981', location: 'Bangalore, Karnataka', description: 'At GadgetHub Pro, we curate the most innovative gadgets and productivity tools for professionals and enthusiasts alike.' },
  { id: '4', name: 'AudioPhile Elite', rating: 5.0, sales: '2k+', image: 'https://api.dicebear.com/7.x/shapes/svg?seed=Audio&backgroundColor=8b5cf6', location: 'New Delhi, Delhi', description: 'Experience sound like never before. AudioPhile Elite brings you the finest selection of headphones, DACs, and speakers from top brands.' }
];
