  ...
  useEffect(() => {
    ...
    if (currentUrlCategory !== null && currentUrlCategory !== currentSelected) {
      setSelectedCategories(
        currentUrlCategory ? currentUrlCategory.split(',') : []
      );
    ...
    queryFn: async () => {
      ...
      if (minPrice)
        products = products.filter(
          (p: any) => (p.salePrice || p.price) >= Number(minPrice)
        );
      if (maxPrice)
        products = products.filter(
          (p: any) => (p.salePrice || p.price) <= Number(maxPrice)
        );
      if (minRating > 0)
  ...
  return (
    <div className="flex flex-col md:flex-row gap-10 mt-8">
      <Helmet>
        ...
        <meta
          name="description"
          content="Browse our complete collection of electronics, gadgets, and accessories."
        />
      </Helmet>
      ...
      <aside className="w-full md:w-72 shrink-0">
        <div className="bg-white/60 backdrop-blur-xl dark:bg-dark-800/60 rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-white/40 dark:border-dark-700/50 sticky top-28">
          <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-gray-200/50 dark:border-dark-700/50">
            ...
            <h3 className="font-bold text-lg dark:text-white tracking-tight">
              Filters
            </h3>
          </div>
                ...
                {categoriesData?.map((cat: any) => (
                  <li key={cat._id}>
                    <label className="flex items-center space-x-3 cursor-pointer group">
                      ...
                      <span className="text-gray-600 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                        {cat.name}
                      </span>
                    </label>
                  </li>
            ...
            <div className="pt-4 border-t border-gray-100 dark:border-dark-700/50">
              ...
              <div className="flex items-center space-x-2 mt-4">
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-dark-900 border border-gray-200 dark:border-dark-700 rounded-lg px-3 py-2 text-sm dark:text-white"
                />
            ...
            <div className="pt-4 border-t border-gray-100 dark:border-dark-700/50">
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 border-2 border-gray-300 dark:border-gray-600 rounded-md checked:bg-primary-600 cursor-pointer"
                />
      ...
      <div className="flex-1">
        ...
        {isLoading ? (
          ...
          <div className="text-red-500 p-6 bg-red-50 dark:bg-red-900/10 rounded-2xl border border-red-100 dark:border-red-900/30">
              ...
              {data?.products?.map((product: any, i: number) => (
                ...
                >
                  ...
                  <Link
                    ...
                    className="relative h-56 bg-gray-50/50 dark:bg-dark-900/50 rounded-2xl mb-5 overflow-hidden flex items-center justify-center mix-blend-multiply dark:mix-blend-normal"
                  >
